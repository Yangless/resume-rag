...
到岗时间:    待定
工作类型:    全职
自我评价:    良好的公共关系意识,善于沟通,具备一定的活动策划和组织协调能力.良好的心态和责任感,吃苦耐劳,善于管理时间,勇于面对变化和挑战.良好的学习能力,习惯制定切实可行的学习计划,勤于学习能不断提高.
工作经验
2020/3-2020/6   滁州市九扬装饰工程有限公司   (3个月)
家居/室内设计/装潢  |  50-150人  |  民营公司
室内设计师助理   (兼职)
工作描述:    测量房屋尺寸,画房型图.整理客户资料和图纸,学习预算,并向客户介绍报价.
2017/7-2017/8   蚌埠市邦妮教育   (1个月)
销售专员
工作描述:    负责补习机构的前期招生计划,和后续的与家长沟通.
教育经历
2016/9-2020/7   蚌埠学院
本科  |   水利水电工程
在校情况
...
async def send_request(session, resume):
    async with session.post('http://172.16.2.21:8010/summary', headers={'token':'d21b5ecb0ade56ca789a959e2bb57074'},json={"text": resume}) as response:
